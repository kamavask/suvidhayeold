...
<head>
	...
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/froala_editor.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/froala_style.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/code_view.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/colors.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/emoticons.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/image_manager.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/image.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/line_breaker.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/table.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/char_counter.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/video.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/fullscreen.css')}}">
	<link rel="stylesheet" href="{{asser('admin/vendor/froala_editor_3.1.1/css/plugins/file.css')}}">
