...
<body class="sb-nav-fixed">
    ...
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/froala_editor.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/align.min.js') }}">
    </script>
    <script type="text/javascript"
        src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/code_beautifier.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/code_view.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/colors.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/emoticons.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/draggable.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/font_size.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/font_family.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/image.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/file.min.js') }}">
    </script>
    <script type="text/javascript"
        src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/image_manager.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/line_breaker.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/link.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/lists.min.js') }}">
    </script>
    <script type="text/javascript"
        src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/paragraph_format.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/paragraph_style.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/video.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/table.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/url.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/entities.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/char_counter.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/inline_style.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/save.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/fullscreen.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('admin/vendor/froala_editor_3.1.1/js/plugins/quote.min.js') }}">
    </script>
    <script>
        (function () {
