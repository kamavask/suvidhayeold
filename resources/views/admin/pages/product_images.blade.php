         ...
         <main>
             <div class="container-fluid">
                 ...
                 <ol class="breadcrumb mb-30">
                     ...
                     <li class="breadcrumb-item"><a href="category.html">Product Image</a></li>
                                 ...
                                 <div class="news-content-right pd-20">
                                     ...
                                     <div class="row" style="margin-bottom:1%">
                                         <div class="col-sm-7">
                                             <!-- text input -->
                                             <div class="form-group">
                                                 <label class="form-label"><b>Default Image</b></label>
                                                 <input type="text" class="form-control" placeholder="Default Image" name="content1">
                                             </div>
                                         </div>
                                     ...
                                     <div class="row" style="margin-bottom:1%">
                                         <div class="col-sm-7">
                                             <!-- text input -->
                                             <div class="form-group">
                                                 <label class="form-label"><b>Multi-Image 1</b></label>
                                                 <input type="text" class="form-control" placeholder="Put Image" name="content2">
                                             </div>
                                         </div>
                                         <div class="col-sm-2"></div>
                                         <div class="col-sm-3">
