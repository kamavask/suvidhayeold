...
@section('content')
    <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-30">
                        ...
                        <li class="breadcrumb-item active">Edit Serviceman</li>
                    </ol>
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="card card-static-2 mb-30">
                                <div class="card-title-1">
                                    <h4>Edit Serviceman</h4>
                                </div>
                                <div class="card-body-table">
                                    <div class="news-content-right pd-20">
                                        <h3 style="text-decoration: underline;">Serviceman Basic Details</h3>
                                        ...
                                        <hr>
                                        <h3 style="text-decoration: underline;">Shop Basic Details</h3>
                                        <div class="row" style="margin-bottom:1%">
                                            <div class="col-sm-6">
                                                <!-- text input -->
                                                <div class="form-group">
                                        ...
                                        <div class="row" style="margin-bottom:1%">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1" class="form-label"><b>Shop Image</b></label>
                                        ...
                                        <div class="row" style="margin-bottom:1%">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Shop Address" name="shop_address">
                                                </div>
                                            </div>
                                        </div>
