		...
		<div class="top-header-group">
			<div class="top-header">
				<div class="res_main_logo">
					<a href="/"><img src="customer\images\logo\white_title.jpg" alt=""></a>
				</div>
				<div class="main_logo" id="logo">
					<a href="/"><img src="customer\images\logo\white_title.jpg" alt=""></a></a>
					<a href="/"><img class="logo-inverse" src="customer\images\logo\black_title.jpg" alt=""></a>
				</div>
		...
		<div class="sub-header-group">
			<div class="sub-header">
				<div class="ui dropdown">
					<a href="#" class="category_drop hover-btn" data-toggle="modal" data-target="#category_model" title="Categories"><i class="fa fa-arrow-up"></i><span class="cate__icon">Upload Your list</span></a>
				</div>
