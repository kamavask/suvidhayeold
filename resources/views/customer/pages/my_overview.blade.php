...
@section('content')
    <div class="wrapper">
		...
		<div class="dashboard-group">
          ...
          <div class="col-lg-3 col-md-12" style="padding-left:20px; padding-right:20px; padding-bottom:50px;">
						<div class="pdpt-bg">
							...
							<div class="ddsh-body">
								...
								<ul>
									<li>
										<a href="#" class="small-reward-dt hover-btn">Won &#x20b9 2</a>
									</li>
									<li>
										<a href="#" class="small-reward-dt hover-btn">Won 40% Off</a>
									</li>
									<li>
										<a href="#" class="small-reward-dt hover-btn">Caskback &#x20b9 1</a>
									</li>
									<li>
