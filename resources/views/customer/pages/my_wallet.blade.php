								...
								<div class="col-lg-6 col-md-12">
									<div class="pdpt-bg">
										<div class="reward-body-dtt">
											...
											<h4 class="cashbk-price">&#x20b9 120</h4>
								...
								<div class="col-lg-6 col-md-12">
									<div class="pdpt-bg">
										<div class="gambo-body-cash">
											...
											<h4 class="cashbk-price">&#x20b9 5</h4>
											...
											<div class="row">
												...
												<div class="col-lg-12 col-md-12">
													<div class="form-group mt-1">
														...
														<div class="ui search focus">
															<div class="ui left icon input swdh11 swdh19">
																<input class="prompt srch_explore" type="text" name="addbalance" maxlength="3" placeholder="&#x20b9 0">															
															</div>
														</div>
													</div>
												</div>
