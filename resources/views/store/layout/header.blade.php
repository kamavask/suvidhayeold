                            ...
                            <li class="nav-item">
                                <div class="ui icon top left dropdown nav__menu">
                                    ...
                                    <div class="menu dropdown_page">
                                        ...
                                        <a href="store/order_placed.html" class="item channel_item page__links">Order
                                            Placed</a>
                                        ...
                                        <a href="store/contact_us.html" class="item channel_item page__links">Contact
                                            Us</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item">
                                <div class="ui icon top left dropdown nav__menu">
                                    ...
                                    <div class="menu dropdown_page">
                                        ...
                                        <a href="store/blog_no_sidebar.html" class="item channel_item page__links">Our
                                            Blog Two No Sidebar</a>
                                        <a href="store/blog_left_sidebar.html" class="item channel_item page__links">Our
                                        ...
                                        <a href="store/blog_detail_view.html" class="item channel_item page__links">Blog
                                            Detail View</a>
