                ...
                <div class="ui search">
                    <div class="ui left icon input swdh10">
                        ...
                        <div class="form-group">
                            ...
                            <form class="form-inline my-2 my-lg-0" type="get" action="{{url('/search')}}">
                                <input type="text" class="form-control mr-sm-2" name="query" type="search"
                                    placeholder="search..." />
                                <button class="btn btn-outline-light my-2 my-sm-0" type="submit">Search</button>
                            </form>
                        </div>
        ...
        <div class="sub-header-group">
            <div class="sub-header">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu"
                            ...
                            <ul class="navbar-nav main_nav align-self-stretch">
                                <li class="nav-item"><a href="store/index.html" class="nav-link active"
                                        title="Home">Home</a></li>
                                <li class="nav-item"><a href="store/shop_grid.html" class="nav-link new_item"
                                        title="New Products">New Products</a></li>
                                <li class="nav-item"><a href="store/shop_grid.html" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <div class="ui icon top left dropdown nav__menu">
                                        ...
                                        <div class="menu dropdown_page">
                                            <a href="store/dashboard_overview.html"
                                                class="item channel_item page__links">Account</a>
                                            <a href="store/about_us.html" class="item channel_item page__links">About
                                                Us</a>
                                            <a href="store/shop_grid.html" class="item channel_item page__links">Shop
                                                Grid</a>
                                            <a href="store/single_product_view.html"
                                                class="item channel_item page__links">Single Product View</a>
                                            <a href="store/checkout.html"
                                                class="item channel_item page__links">Checkout</a>
                                            <a href="store/request_product.html"
                                                class="item channel_item page__links">Product Request</a>
                                            <a href="store/order_placed.html"
                                                class="item channel_item page__links">Order
                                                Placed</a>
                                            <a href="store/bill.html" class="item channel_item page__links">Bill
                                                Slip</a>
                                            <a href="store/sign_in.html" class="item channel_item page__links">Sign
                                                In</a>
                                            <a href="store/sign_up.html" class="item channel_item page__links">Sign
                                                Up</a>
                                            <a href="store/forgot_password.html"
                                                class="item channel_item page__links">Forgot Password</a>
                                            <a href="store/contact_us.html"
                                                class="item channel_item page__links">Contact
                                                Us</a>
                                        </div>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <div class="ui icon top left dropdown nav__menu">
                                        ...
                                        <div class="menu dropdown_page">
                                            <a href="store/our_blog.html" class="item channel_item page__links">Our
                                                Blog</a>
                                            <a href="store/blog_no_sidebar.html"
                                                class="item channel_item page__links">Our
                                                Blog Two No Sidebar</a>
                                            <a href="store/blog_left_sidebar.html"
                                                class="item channel_item page__links">Our
                                                Blog with Left Sidebar</a>
                                            <a href="store/blog_right_sidebar.html"
                                                class="item channel_item page__links">Our Blog with Right Sidebar</a>
                                            <a href="store/blog_detail_view.html"
                                                class="item channel_item page__links">Blog
                                                Detail View</a>
                                            <a href="store/blog_left_sidebar_single_view.html"
                                                class="item channel_item page__links">Blog Detail View with Sidebar</a>
                                        </div>
                                    </div>
                                </li>
                                <li class="nav-item"><a href="store/contact_us.html" class="nav-link"
                ...
                <div class="header_cart order-1">
                    <a href="{{url('/cart')}}" class="cart__btn hover-btn pull-bs-canvas-left" title="Cart"><i
