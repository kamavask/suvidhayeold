                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="product-dt-right">
                                    ...
                                    <div class="product-group-dt">
                                        <ul>
                                            <li>
                                                <div class="main-price mrp-price"><span>Rs.{{$product->r_price}}</span>
                                                </div>
                                            </li>
                                            <li>
                                        ...
                                        <ul class="ordr-crt-share">
                                            <form action="{{ route('cart.store') }}" method="POST">
                                                ...
                                                <input type="hidden" name="sprice" value="{{$product->s_price}}">
                                    ...
                                    <ul class="pp-descp">
                                        ...
                                        for ($i=0; $i <count($hlarray); $i++) { echo "<li>$hlarray[$i]</li>" ; } @endphp
                                            </ul> <div class="pdp-details">
                                            <ul>
                                                <li>
                                ...
                                <table style="width:80%" class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Strictly test one by one to make sure all the goods is best quality,
